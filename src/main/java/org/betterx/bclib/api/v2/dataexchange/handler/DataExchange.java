...
@EventBusSubscriber(modid = org.betterx.bclib.BCLib.MOD_ID)
abstract public class DataExchange {
    ...
    public static void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        api.server.onPlayInit(player.connection, player.level().getServer());
        api.server.onPlayReady(player.connection, player.level().getServer());
    }
    ...
    public static void onPlayerLoggedOut(PlayerEvent.PlayerLoggedOutEvent event) {
        DataExchange api = getInstance();
        ServerPlayer player = (ServerPlayer) event.getEntity();
        api.server.onPlayDisconnect(player.connection, player.level().getServer());
    }
